...
const domesticRegions = [
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Kalimpong',   coords: [88.47, 27.07] as [number, number] },
      { name: 'Kasol',       coords: [77.31, 32.01] as [number, number] },
      { name: 'Kasauli',     coords: [76.96, 30.90] as [number, number] },
      { name: 'Auli',        coords: [79.56, 30.52] as [number, number] },
      { name: 'Chail',       coords: [77.20, 30.96] as [number, number] },
      { name: 'Dalhousie',   coords: [75.97, 32.54] as [number, number] },
      { name: 'Lansdowne',   coords: [78.69, 29.84] as [number, number] },
      { name: 'Spiti Valley',coords: [78.03, 32.24] as [number, number] },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Neemrana',       coords: [76.39, 27.99] as [number, number] },
      { name: 'Mount Abu',      coords: [72.72, 24.59] as [number, number] },
      { name: 'Nagpur',         coords: [79.09, 21.15] as [number, number] },
      { name: 'Mahabaleshwar',  coords: [73.66, 17.92] as [number, number] },
      { name: 'Lonavala',       coords: [73.40, 18.75] as [number, number] },
      { name: 'Khandala',       coords: [73.39, 18.77] as [number, number] },
      { name: 'Lavasa',         coords: [73.51, 18.40] as [number, number] },
      { name: 'Igatpuri',       coords: [73.55, 19.70] as [number, number] },
      { name: 'Alibaug',        coords: [72.87, 18.64] as [number, number] },
      { name: 'Daman and Diu',  coords: [72.83, 20.40] as [number, number] },
    ],
  },
  {
    ...
    cities: [
      ...
      { name: 'Siliguri',     coords: [88.40, 26.73] as [number, number] },
      { name: 'Tawang',       coords: [91.86, 27.59] as [number, number] },
  ...
  {
    label: 'Central India', color: '#f472b6',
    cities: [
      { name: 'Bhopal',  coords: [77.41, 23.26] as [number, number] },
      { name: 'Indore',  coords: [75.86, 22.72] as [number, number] },
      { name: 'Kanha',   coords: [80.61, 22.33] as [number, number] },
      { name: 'Pench',   coords: [79.29, 21.74] as [number, number] },
    ],
  },
];
