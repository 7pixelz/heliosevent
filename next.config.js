...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ── /services/<slug> → /<slug> (service pages moved to root, Aug 2026) ──
      { source: '/services/brand-activations',                              destination: '/brand-activations',                              permanent: true },
      { source: '/services/brand-activations/',                             destination: '/brand-activations',                              permanent: true },
      { source: '/services/business-meeting-organizer-in-chennai',          destination: '/business-meeting-organizer-in-chennai',          permanent: true },
      { source: '/services/business-meeting-organizer-in-chennai/',         destination: '/business-meeting-organizer-in-chennai',          permanent: true },
      { source: '/services/conferences-seminars',                          destination: '/conferences-seminars',                            permanent: true },
      { source: '/services/conferences-seminars/',                         destination: '/conferences-seminars',                            permanent: true },
      { source: '/services/corporate-event-management-in-chennai',          destination: '/corporate-event-management-in-chennai',          permanent: true },
      { source: '/services/corporate-event-management-in-chennai/',         destination: '/corporate-event-management-in-chennai',          permanent: true },
      { source: '/services/entertainment-event-organizer-in-chennai',       destination: '/entertainment-event-organizer-in-chennai',       permanent: true },
      { source: '/services/entertainment-event-organizer-in-chennai/',      destination: '/entertainment-event-organizer-in-chennai',       permanent: true },
      { source: '/services/exhibition-organizer-in-chennai',                destination: '/exhibition-organizer-in-chennai',                permanent: true },
      { source: '/services/exhibition-organizer-in-chennai/',               destination: '/exhibition-organizer-in-chennai',                permanent: true },
      { source: '/services/gen-z-centric-event-management-in-chennai',      destination: '/gen-z-centric-event-management-in-chennai',      permanent: true },
      { source: '/services/gen-z-centric-event-management-in-chennai/',     destination: '/gen-z-centric-event-management-in-chennai',      permanent: true },
      { source: '/services/government-events-planner-in-chennai',          destination: '/government-events-planner-in-chennai',           permanent: true },
      { source: '/services/government-events-planner-in-chennai/',         destination: '/government-events-planner-in-chennai',           permanent: true },
      { source: '/services/sports-event-management-company-in-chennai',    destination: '/sports-event-management-company-in-chennai',     permanent: true },
      { source: '/services/sports-event-management-company-in-chennai/',   destination: '/sports-event-management-company-in-chennai',     permanent: true },
      { source: '/services/team-building-activities',                      destination: '/team-building-activities',                        permanent: true },
      { source: '/services/team-building-activities/',                     destination: '/team-building-activities',                        permanent: true },
      { source: '/services/virtual-hybrid-event-management-in-chennai',    destination: '/virtual-hybrid-event-management-in-chennai',     permanent: true },
      { source: '/services/virtual-hybrid-event-management-in-chennai/',   destination: '/virtual-hybrid-event-management-in-chennai',     permanent: true },
      // Note: cultural-performances, corporate-games-sports, employee-engagement, and
      // wedding-event-planner-in-chennai are active service slugs but intentionally
      // excluded here — each already has its own dedicated /services/<slug> redirect
      // rule elsewhere in this file (content consolidation / external wedding site),
      // which this migration preserves as-is.
      ...
      { source: '/services/cultural-performances',                    destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/services/cultural-performances/',                   destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/services/employee-engagement',                      destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/services/employee-engagement/',                     destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/services/corporate-games-sports',                   destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/services/corporate-games-sports/',                  destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-sriperumbudur',         destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-sriperumbudur/',        destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-guindy',                destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-guindy/',               destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-ambattur',              destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-ambattur/',             destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-porur',                   destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-porur/',                  destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-planner-in-taramani',                   destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-planner-in-taramani/',                  destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-omr',                     destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-omr/',                    destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-oragadam',                destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-oragadam/',               destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-vallam-chengalpattu',     destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-vallam-chengalpattu/',    destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-ekkatuthangal',           destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-ekkatuthangal/',          destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-sri-city',                destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-sri-city/',               destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-siruseri',                destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-management-in-siruseri/',               destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-planner-in-anna-salai',                 destination: '/corporate-event-management-in-chennai', permanent: true },
      { source: '/chennai/event-planner-in-anna-salai/',                destination: '/corporate-event-management-in-chennai', permanent: true },

      // ── Old WordPress root service slugs (all linked from blog posts) ──
      { source: '/corporate-events',                destination: '/corporate-event-management-in-chennai',  permanent: true },
      { source: '/corporate-events/',               destination: '/corporate-event-management-in-chennai',  permanent: true },
      { source: '/employee-engagement',             destination: '/corporate-event-management-in-chennai',  permanent: true },
      { source: '/employee-engagement/',            destination: '/corporate-event-management-in-chennai',  permanent: true },
      { source: '/government-protocol-events',      destination: '/government-events-planner-in-chennai',   permanent: true },
      { source: '/government-protocol-events/',     destination: '/government-events-planner-in-chennai',   permanent: true },
      { source: '/exhibition',                      destination: '/exhibition-organizer-in-chennai',        permanent: true },
      { source: '/exhibition/',                     destination: '/exhibition-organizer-in-chennai',        permanent: true },
      { source: '/btl-activations',                 destination: '/brand-activations',                      permanent: true },
      { source: '/btl-activations/',                destination: '/brand-activations',                      permanent: true },

      // ── Old /services/* generic slugs (found 404 in Search Console) ──
      { source: '/services/corporate-events',                 destination: '/corporate-event-management-in-chennai',    permanent: true },
      { source: '/services/corporate-events/',                destination: '/corporate-event-management-in-chennai',    permanent: true },
      { source: '/services/mice-events',                      destination: '/business-meeting-organizer-in-chennai',    permanent: true },
      { source: '/services/mice-events/',                     destination: '/business-meeting-organizer-in-chennai',    permanent: true },
      { source: '/services/exhibitions',                      destination: '/exhibition-organizer-in-chennai',          permanent: true },
      { source: '/services/exhibitions/',                     destination: '/exhibition-organizer-in-chennai',          permanent: true },
      { source: '/services/government-protocol-events',       destination: '/government-events-planner-in-chennai',     permanent: true },
      { source: '/services/government-protocol-events/',      destination: '/government-events-planner-in-chennai',     permanent: true },
      ...
      { source: '/services/conference-seminars-organizer-in-chennai',  destination: '/conferences-seminars',                permanent: true },
      { source: '/services/conference-seminars-organizer-in-chennai/', destination: '/conferences-seminars',                permanent: true },
      { source: '/services/press-conference-organizer-in-chennai',     destination: '/government-events-planner-in-chennai', permanent: true },
      { source: '/services/press-conference-organizer-in-chennai/',    destination: '/government-events-planner-in-chennai', permanent: true },
      { source: '/services/channel-partner-meeting-organizer-in-chennai',  destination: '/business-meeting-organizer-in-chennai', permanent: true },
      { source: '/services/channel-partner-meeting-organizer-in-chennai/', destination: '/business-meeting-organizer-in-chennai', permanent: true },

      // ── Old service pages → active service pages only ──
      { source: '/mice',                                    destination: '/business-meeting-organizer-in-chennai',            permanent: true },
      { source: '/mice/',                                   destination: '/business-meeting-organizer-in-chennai',            permanent: true },
      { source: '/sports-events',                           destination: '/sports-event-management-company-in-chennai',       permanent: true },
      { source: '/sports-events/',                          destination: '/sports-event-management-company-in-chennai',       permanent: true },
      { source: '/corporate-event-organisers-in-chennai',  destination: '/corporate-event-management-in-chennai',            permanent: true },
      { source: '/corporate-event-organisers-in-chennai/', destination: '/corporate-event-management-in-chennai',            permanent: true },
      ...
      { source: '/entertainment-events',  destination: '/entertainment-event-organizer-in-chennai', permanent: true },
      { source: '/entertainment-events/', destination: '/entertainment-event-organizer-in-chennai', permanent: true },
      ...
      { source: '/services/wedding-event-planner-in-chennai/',       destination: 'https://www.nakshatrawedding.com/', permanent: true },
      { source: '/press-meets',  destination: '/government-events-planner-in-chennai', permanent: true },
      { source: '/press-meets/', destination: '/government-events-planner-in-chennai', permanent: true },
      ...
      { source: '/services/employee-engagement-planner-in-chennai/',  destination: '/', permanent: true },
      { source: '/services/trade-show-organizer-in-chennai',          destination: '/exhibition-organizer-in-chennai', permanent: true },
      { source: '/services/trade-show-organizer-in-chennai/',         destination: '/exhibition-organizer-in-chennai', permanent: true },
